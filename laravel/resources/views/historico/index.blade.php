                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="de" name="de" value="{{ request('de') }}">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                <label for="ate" class="form-label">Até</label>
                                <input type="date" class="form-control" id="ate" name="ate" value="{{ request('ate') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    ...
                    @if(request()->hasAny(['sobremesa_id', 'tipo', 'de', 'ate']))
